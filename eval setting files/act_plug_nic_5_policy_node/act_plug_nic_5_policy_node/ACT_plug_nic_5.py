...
class ACT_plug_nic_5(Policy):
    def __init__(self, parent_node: Node):
        ...
        # -------------------------------------------------------------------------
        repo_id = "Ac31415/policy_act_plug_into_nic_5"
    ...
    def insert_cable(
        ...
        **kwargs,
        ...
        self.policy.reset()
        self.get_logger().info(f"ACT_plug_nic_5.insert_cable() enter. Task: {task}")
        ...
        while time.time() - start_time < 30.0:
            ...
            # print(f"Raw observation received: {observation_msg}")
