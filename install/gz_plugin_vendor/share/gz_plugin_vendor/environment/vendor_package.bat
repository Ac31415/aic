...
call:ament_prepend_unique_value DYLD_LIBRARY_PATH "%AMENT_CURRENT_PREFIX%\opt\gz_plugin_vendor\lib"
call:ament_prepend_unique_value DYLD_LIBRARY_PATH "%AMENT_CURRENT_PREFIX%\opt\gz_plugin_vendor\lib64"
