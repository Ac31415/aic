# - Config file for the gz-plugin3-loader component
#
# This should only be invoked by gz-plugin3-config.cmake.
#
# To load this component into your project, use:
# find_package(gz-plugin3 COMPONENTS loader)
#
# This creates the following targets:
#
#   Component library target                - gz-plugin3::gz-plugin3-loader
#   Alternative target name                 - gz-plugin3::loader
...
# this is discouraged:
#
#   gz-plugin3-loader_LIBRARY  - Component library (actually contains gz-plugin3::loader)
#
# We will also set gz-plugin3-loader_FOUND to indicate that the component was found.
#
################################################################################
...
if(gz-plugin3-loader_CONFIG_INCLUDED)
  return()
endif()
set(gz-plugin3-loader_CONFIG_INCLUDED TRUE)

if(NOT gz-plugin3-loader_FIND_QUIETLY)
  message(STATUS "Looking for gz-plugin3-loader -- found version 3.1.0")
endif()
...
# dependencies.
if(gz-plugin3-loader_FIND_REQUIRED)
...
# dependencies.
if(gz-plugin3-loader_FIND_QUIETLY)
...
if(NOT gz-plugin3-loader_FIND_QUIETLY)
  message(STATUS "Searching for dependencies of gz-plugin3-loader")
endif()
...
if(NOT TARGET gz-plugin3::gz-plugin3-loader)
  include("${CMAKE_CURRENT_LIST_DIR}/gz-plugin3-loader-targets.cmake")

  # Create a simplified imported target name for the loader library.
  # You can link to this target instead of the loader library.
  add_library(gz-plugin3::loader INTERFACE IMPORTED)
  set_target_properties(gz-plugin3::loader PROPERTIES
    INTERFACE_LINK_LIBRARIES "gz-plugin3::gz-plugin3-loader")
...
if(NOT gz_requested_components)
  ...
  set_target_properties(gz-plugin3::requested PROPERTIES
    INTERFACE_LINK_LIBRARIES "${gz_requested_components};gz-plugin3::gz-plugin3-loader")
endif()

set(gz-plugin3-loader_LIBRARY gz-plugin3::gz-plugin3-loader)

# This macro is used by gz-cmake to automatically configure the pkgconfig
# files for Gazebo projects.
gz_pkg_config_entry(gz-plugin3-loader "gz-plugin3-loader")
