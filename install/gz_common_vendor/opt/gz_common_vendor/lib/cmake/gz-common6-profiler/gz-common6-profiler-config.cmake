# - Config file for the gz-common6-profiler component
#
# This should only be invoked by gz-common6-config.cmake.
#
# To load this component into your project, use:
# find_package(gz-common6 COMPONENTS profiler)
#
# This creates the following targets:
#
#   Component library target                - gz-common6::gz-common6-profiler
#   Alternative target name                 - gz-common6::profiler
...
# this is discouraged:
#
#   gz-common6-profiler_LIBRARY  - Component library (actually contains gz-common6::profiler)
#
# We will also set gz-common6-profiler_FOUND to indicate that the component was found.
#
################################################################################
...
if(gz-common6-profiler_CONFIG_INCLUDED)
  return()
endif()
set(gz-common6-profiler_CONFIG_INCLUDED TRUE)

if(NOT gz-common6-profiler_FIND_QUIETLY)
  message(STATUS "Looking for gz-common6-profiler -- found version 6.2.1")
endif()
...
# dependencies.
if(gz-common6-profiler_FIND_REQUIRED)
...
# dependencies.
if(gz-common6-profiler_FIND_QUIETLY)
...
if(NOT gz-common6-profiler_FIND_QUIETLY)
  message(STATUS "Searching for dependencies of gz-common6-profiler")
endif()
...
if(NOT TARGET gz-common6::gz-common6-profiler)
  include("${CMAKE_CURRENT_LIST_DIR}/gz-common6-profiler-targets.cmake")
  ...
  add_library(gz-common6::profiler INTERFACE IMPORTED)
  set_target_properties(gz-common6::profiler PROPERTIES
    INTERFACE_LINK_LIBRARIES "gz-common6::gz-common6-profiler")
...
if(NOT gz_requested_components)
  ...
  set_target_properties(gz-common6::requested PROPERTIES
    INTERFACE_LINK_LIBRARIES "${gz_requested_components};gz-common6::gz-common6-profiler")
endif()

set(gz-common6-profiler_LIBRARY gz-common6::gz-common6-profiler)

# This macro is used by gz-cmake to automatically configure the pkgconfig
# files for Gazebo projects.
gz_pkg_config_entry(gz-common6-profiler "gz-common6-profiler")
