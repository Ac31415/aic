# - Config file for the gz-common6-testing component
#
# This should only be invoked by gz-common6-config.cmake.
#
# To load this component into your project, use:
# find_package(gz-common6 COMPONENTS testing)
#
# This creates the following targets:
#
#   Component library target                - gz-common6::gz-common6-testing
#   Alternative target name                 - gz-common6::testing
...
# this is discouraged:
#
#   gz-common6-testing_LIBRARY  - Component library (actually contains gz-common6::testing)
#
# We will also set gz-common6-testing_FOUND to indicate that the component was found.
#
################################################################################
...
if(gz-common6-testing_CONFIG_INCLUDED)
  return()
endif()
set(gz-common6-testing_CONFIG_INCLUDED TRUE)

if(NOT gz-common6-testing_FIND_QUIETLY)
  message(STATUS "Looking for gz-common6-testing -- found version 6.2.1")
endif()
...
# dependencies.
if(gz-common6-testing_FIND_REQUIRED)
...
# dependencies.
if(gz-common6-testing_FIND_QUIETLY)
...
if(NOT gz-common6-testing_FIND_QUIETLY)
  message(STATUS "Searching for dependencies of gz-common6-testing")
endif()
...
if(NOT TARGET gz-common6::gz-common6-testing)
  include("${CMAKE_CURRENT_LIST_DIR}/gz-common6-testing-targets.cmake")
  ...
  add_library(gz-common6::testing INTERFACE IMPORTED)
  set_target_properties(gz-common6::testing PROPERTIES
    INTERFACE_LINK_LIBRARIES "gz-common6::gz-common6-testing")
...
if(NOT gz_requested_components)
  ...
  set_target_properties(gz-common6::requested PROPERTIES
    INTERFACE_LINK_LIBRARIES "${gz_requested_components};gz-common6::gz-common6-testing")
endif()

set(gz-common6-testing_LIBRARY gz-common6::gz-common6-testing)

# This macro is used by gz-cmake to automatically configure the pkgconfig
# files for Gazebo projects.
gz_pkg_config_entry(gz-common6-testing "gz-common6-testing")
