# - Config file for the gz-common6-io component
#
# This should only be invoked by gz-common6-config.cmake.
#
# To load this component into your project, use:
# find_package(gz-common6 COMPONENTS io)
#
# This creates the following targets:
#
#   Component library target                - gz-common6::gz-common6-io
#   Alternative target name                 - gz-common6::io
...
# this is discouraged:
#
#   gz-common6-io_LIBRARY  - Component library (actually contains gz-common6::io)
#
# We will also set gz-common6-io_FOUND to indicate that the component was found.
#
################################################################################
...
if(gz-common6-io_CONFIG_INCLUDED)
  return()
endif()
set(gz-common6-io_CONFIG_INCLUDED TRUE)

if(NOT gz-common6-io_FIND_QUIETLY)
  message(STATUS "Looking for gz-common6-io -- found version 6.2.1")
endif()
...
# dependencies.
if(gz-common6-io_FIND_REQUIRED)
...
if(NOT gz-common6-io_FIND_QUIETLY)
  message(STATUS "Searching for dependencies of gz-common6-io")
endif()
...
if(NOT TARGET gz-common6::gz-common6-io)
  include("${CMAKE_CURRENT_LIST_DIR}/gz-common6-io-targets.cmake")

  # Create a simplified imported target name for the io library.
  # You can link to this target instead of the io library.
  add_library(gz-common6::io INTERFACE IMPORTED)
  set_target_properties(gz-common6::io PROPERTIES
    INTERFACE_LINK_LIBRARIES "gz-common6::gz-common6-io")
...
if(NOT gz_requested_components)
  ...
  set_target_properties(gz-common6::requested PROPERTIES
    INTERFACE_LINK_LIBRARIES "${gz_requested_components};gz-common6::gz-common6-io")
endif()

set(gz-common6-io_LIBRARY gz-common6::gz-common6-io)

# This macro is used by gz-cmake to automatically configure the pkgconfig
# files for Gazebo projects.
gz_pkg_config_entry(gz-common6-io "gz-common6-io")
