...
bool controller_manager_msgs__srv__reload_controller_libraries__request__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("controller_manager_msgs.srv._reload_controller_libraries", (char *)PyUnicode_1BYTE_DATA(module_attr), 56) == 0);
    assert(strncmp("ReloadControllerLibraries_Request", (char *)PyUnicode_1BYTE_DATA(name_attr), 33) == 0);
...
bool controller_manager_msgs__srv__reload_controller_libraries__response__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    // PyUnicode_1BYTE_DATA is just a cast
    assert(strncmp("controller_manager_msgs.srv._reload_controller_libraries", (char *)PyUnicode_1BYTE_DATA(module_attr), 56) == 0);
    assert(strncmp("ReloadControllerLibraries_Response", (char *)PyUnicode_1BYTE_DATA(name_attr), 34) == 0);
...
bool controller_manager_msgs__srv__reload_controller_libraries__event__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    // PyUnicode_1BYTE_DATA is just a cast
    assert(strncmp("controller_manager_msgs.srv._reload_controller_libraries", (char *)PyUnicode_1BYTE_DATA(module_attr), 56) == 0);
    assert(strncmp("ReloadControllerLibraries_Event", (char *)PyUnicode_1BYTE_DATA(name_attr), 31) == 0);
