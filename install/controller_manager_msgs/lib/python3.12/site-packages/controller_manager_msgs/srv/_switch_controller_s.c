...
bool controller_manager_msgs__srv__switch_controller__request__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("controller_manager_msgs.srv._switch_controller", (char *)PyUnicode_1BYTE_DATA(module_attr), 46) == 0);
    assert(strncmp("SwitchController_Request", (char *)PyUnicode_1BYTE_DATA(name_attr), 24) == 0);
...
bool controller_manager_msgs__srv__switch_controller__response__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    // PyUnicode_1BYTE_DATA is just a cast
    assert(strncmp("controller_manager_msgs.srv._switch_controller", (char *)PyUnicode_1BYTE_DATA(module_attr), 46) == 0);
    assert(strncmp("SwitchController_Response", (char *)PyUnicode_1BYTE_DATA(name_attr), 25) == 0);
...
bool controller_manager_msgs__srv__switch_controller__event__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    // PyUnicode_1BYTE_DATA is just a cast
    assert(strncmp("controller_manager_msgs.srv._switch_controller", (char *)PyUnicode_1BYTE_DATA(module_attr), 46) == 0);
    assert(strncmp("SwitchController_Event", (char *)PyUnicode_1BYTE_DATA(name_attr), 22) == 0);
