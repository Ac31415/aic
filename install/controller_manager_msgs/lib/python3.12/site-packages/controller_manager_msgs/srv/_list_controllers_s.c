...
bool controller_manager_msgs__srv__list_controllers__request__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("controller_manager_msgs.srv._list_controllers", (char *)PyUnicode_1BYTE_DATA(module_attr), 45) == 0);
    assert(strncmp("ListControllers_Request", (char *)PyUnicode_1BYTE_DATA(name_attr), 23) == 0);
...
bool controller_manager_msgs__srv__list_controllers__response__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    // PyUnicode_1BYTE_DATA is just a cast
    assert(strncmp("controller_manager_msgs.srv._list_controllers", (char *)PyUnicode_1BYTE_DATA(module_attr), 45) == 0);
    assert(strncmp("ListControllers_Response", (char *)PyUnicode_1BYTE_DATA(name_attr), 24) == 0);
...
bool controller_manager_msgs__srv__list_controllers__event__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    // PyUnicode_1BYTE_DATA is just a cast
    assert(strncmp("controller_manager_msgs.srv._list_controllers", (char *)PyUnicode_1BYTE_DATA(module_attr), 45) == 0);
    assert(strncmp("ListControllers_Event", (char *)PyUnicode_1BYTE_DATA(name_attr), 21) == 0);
