...
bool controller_manager_msgs__msg__chain_connection__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("controller_manager_msgs.msg._chain_connection", (char *)PyUnicode_1BYTE_DATA(module_attr), 45) == 0);
    assert(strncmp("ChainConnection", (char *)PyUnicode_1BYTE_DATA(name_attr), 15) == 0);
