...
set_target_properties(joint_limits::joint_limiter_interface PROPERTIES
  IMPORTED_LOCATION_NOCONFIG "${_IMPORT_PREFIX}/lib/libjoint_limiter_interface.dylib"
  IMPORTED_SONAME_NOCONFIG "@rpath/libjoint_limiter_interface.dylib"
  )

list(APPEND _cmake_import_check_targets joint_limits::joint_limiter_interface )
list(APPEND _cmake_import_check_files_for_joint_limits::joint_limiter_interface "${_IMPORT_PREFIX}/lib/libjoint_limiter_interface.dylib" )
...
set_target_properties(joint_limits::joint_saturation_limiter PROPERTIES
  IMPORTED_LOCATION_NOCONFIG "${_IMPORT_PREFIX}/lib/libjoint_saturation_limiter.dylib"
  IMPORTED_SONAME_NOCONFIG "@rpath/libjoint_saturation_limiter.dylib"
  )

list(APPEND _cmake_import_check_targets joint_limits::joint_saturation_limiter )
list(APPEND _cmake_import_check_files_for_joint_limits::joint_saturation_limiter "${_IMPORT_PREFIX}/lib/libjoint_saturation_limiter.dylib" )
...
set_target_properties(joint_limits::joint_limits_helpers PROPERTIES
  IMPORTED_LOCATION_NOCONFIG "${_IMPORT_PREFIX}/lib/libjoint_limits_helpers.dylib"
  IMPORTED_SONAME_NOCONFIG "@rpath/libjoint_limits_helpers.dylib"
  )

list(APPEND _cmake_import_check_targets joint_limits::joint_limits_helpers )
list(APPEND _cmake_import_check_files_for_joint_limits::joint_limits_helpers "${_IMPORT_PREFIX}/lib/libjoint_limits_helpers.dylib" )
