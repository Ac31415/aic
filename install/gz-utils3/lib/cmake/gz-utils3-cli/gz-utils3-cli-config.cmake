# - Config file for the gz-utils3-cli component
#
# This should only be invoked by gz-utils3-config.cmake.
#
# To load this component into your project, use:
# find_package(gz-utils3 COMPONENTS cli)
#
# This creates the following targets:
#
#   Component library target                - gz-utils3::gz-utils3-cli
#   Alternative target name                 - gz-utils3::cli
...
# this is discouraged:
#
#   gz-utils3-cli_LIBRARY  - Component library (actually contains gz-utils3::cli)
#
# We will also set gz-utils3-cli_FOUND to indicate that the component was found.
#
################################################################################
...
if(gz-utils3-cli_CONFIG_INCLUDED)
  return()
endif()
set(gz-utils3-cli_CONFIG_INCLUDED TRUE)

if(NOT gz-utils3-cli_FIND_QUIETLY)
  message(STATUS "Looking for gz-utils3-cli -- found version 3.1.1")
endif()
...
# dependencies.
if(gz-utils3-cli_FIND_REQUIRED)
...
if(NOT gz-utils3-cli_FIND_QUIETLY)
  message(STATUS "Searching for dependencies of gz-utils3-cli")
endif()

# --------------------------------

if(NOT TARGET gz-utils3::gz-utils3-cli)
  include("${CMAKE_CURRENT_LIST_DIR}/gz-utils3-cli-targets.cmake")

  # Create a simplified imported target name for the cli library.
  # You can link to this target instead of the cli library.
  add_library(gz-utils3::cli INTERFACE IMPORTED)
  set_target_properties(gz-utils3::cli PROPERTIES
    INTERFACE_LINK_LIBRARIES "gz-utils3::gz-utils3-cli")
...
if(NOT gz_requested_components)
  ...
  set_target_properties(gz-utils3::requested PROPERTIES
    INTERFACE_LINK_LIBRARIES "${gz_requested_components};gz-utils3::gz-utils3-cli")
endif()

set(gz-utils3-cli_LIBRARY gz-utils3::gz-utils3-cli)

# This macro is used by gz-cmake to automatically configure the pkgconfig
# files for Gazebo projects.
gz_pkg_config_entry(gz-utils3-cli "gz-utils3-cli")
