...
class act_trained_0_policy_node(Policy):
    def __init__(self, parent_node: Node):
        ...
        # -------------------------------------------------------------------------
        repo_id = "caai-aic/act_short_all_aic_dataset_policy"
    ...
    def insert_cable(
        ...
        **kwargs,
        ...
        self.policy.reset()
        self.get_logger().info(f"act_trained_0_policy_node.insert_cable() enter. Task: {task}")
        ...
        self.get_logger().info("act_trained_0_policy_node.insert_cable() exiting...")
        return True
